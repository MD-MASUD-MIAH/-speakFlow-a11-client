    ...
    <div className="py-6 overflow-x-hidden">
      <div>
        ...
        <p className="text-center pt-4 pb-10  text-[#7f8c8d]">
          Choose the perfect plan for your writing journey. Whether you're just
          getting started or ready to
          <br />{" "}
          <span className="hidden md:block">
            scale your content, we have a plan that fits your needs.{" "}
          </span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-3  gap-4">
        <div
          ref={ref}
          className={`card  bg-base-100 s overflow-hidden shadow-lg  w-11/12 mx-auto transform transition-all duration-700 ease-out
           ${
             setRef ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20"
           } border ${isDark ? "border-white" : "border-[#550527]"}`}
        >
          <div className="card-body">
            <span className="badge badge-xs text-white badge-warning bg-[#550527]">
              Basic
            </span>
